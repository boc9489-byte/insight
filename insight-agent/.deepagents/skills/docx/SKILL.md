...
uv run python scripts/comment.py unpacked/ 1 "Reply text" --parent 0  # reply to comment 0
uv run python scripts/comment.py unpacked/ 0 "Text" --author "Custom Author"  # custom author name
```
