...
Usage: uv run python clean.py <unpacked_dir>

Example:
    uv run python clean.py unpacked/
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        print("Usage: uv run python clean.py <unpacked_dir>", file=sys.stderr)
        print("Example: uv run python clean.py unpacked/", file=sys.stderr)
        sys.exit(1)
